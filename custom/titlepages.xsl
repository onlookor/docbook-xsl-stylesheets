...
<fo:block xsl:use-attribute-sets="book.titlepage.recto.style" text-align="center" font-size="42.9982pt" space-before="32.2486pt" font-weight="bold" font-family="{$title.fontset}">
<xsl:call-template name="division.title">
...
<fo:block xsl:use-attribute-sets="part.titlepage.recto.style" text-align="center" font-size="35.8318pt" space-before="26.8738pt" font-weight="bold" font-family="{$title.fontset}">
<xsl:call-template name="division.title">
...
<fo:block xsl:use-attribute-sets="chapter.titlepage.recto.style" font-size="29.8598pt" font-weight="bold">
<xsl:call-template name="component.title">
...
<fo:block xsl:use-attribute-sets="chapter.titlepage.recto.style" space-before="0.5em" font-style="italic" font-size="17.28pt" font-weight="bold">
